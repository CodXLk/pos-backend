...
public interface InvoiceRepository extends JpaRepository<InvoiceEntity, UUID> {
    ...
    List<InvoiceEntity> findByBranchIdOrderByInvoiceDateDesc(UUID branchId);
    List<InvoiceEntity> findByCompanyIdOrderByInvoiceDateDesc(UUID companyId); // ADD THIS METHOD
